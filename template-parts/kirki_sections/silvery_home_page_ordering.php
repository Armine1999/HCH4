...
if (! is_plugin_active('slivery-extender/slivery-extender.php') ) {
	new \Kirki\Section(
		...
		[
			'title'       => esc_html__( 'Home Page Ordering Section', 'goldy-silver' ),
	...
	Kirki::add_field( 'goldy_silver_recommand_ordering_activ_section', [
		'type'      => 'goldy-silver-gp-upsell-active',
		'settings'  => 'goldy_silver_recommand_ordering_activ_section',
		'text'  => $lablefore,
		'reg_url'  => $plugin_dir,
