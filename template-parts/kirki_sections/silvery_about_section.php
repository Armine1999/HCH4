...
if (! is_plugin_active('slivery-extender/slivery-extender.php') ) {
	new \Kirki\Section(
		'about_section',
		[
			'title'       => esc_html__( 'About Section', 'goldy-silver' ),
	...
	Kirki::add_field( 'goldy_silver_recommand_about_activ_section', [
		'type'      => 'goldy-silver-gp-upsell-active',
		'settings'  => 'goldy_silver_recommand_about_activ_section',
		'text'  => $lablefore,
		'reg_url'  => $plugin_dir,
