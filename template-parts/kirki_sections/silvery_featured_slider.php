...
// Theme Option
	new \Kirki\Panel(
		...
		[
			'priority'    => 10,
			'title'       => esc_html__( 'Theme Option', 'goldy-silver' ),
		]
	);
...
// Featured Slider Section
	new \Kirki\Section(
		...
		[
			'title'       => esc_html__( 'Featured Slider', 'goldy-silver' ),
	...
	new \Kirki\Field\Repeater(
		[
			'settings' => 'goldy_silver_featuredimage_slider',
			'label'    => esc_html__( 'Featured Slider Items Content', 'goldy-silver' ),
			...
			'fields'   => [
				...
				'link_url'    => [
					'type'        => 'text',
					'label'       => esc_html__( 'Link URL', 'goldy-silver' ),
				],
				'link_text'   => [
					'type'        => 'text',
					'label'       => esc_html__( 'Button text:', 'goldy-silver' ),
				],
			],
			'partial_refresh'    => [
				'goldy_silver_featuredimage_slider' => [
					...
					'render_callback' => function() {
					    return get_theme_mod('goldy_silver_featuredimage_slider');
					}
				],
			],
			'choices' => [
				'limit' => ($goldy_silver_themetype['themtypeis']=='normal') ? 1 : 100,
			]
		]
	);
	...
	// Slider Design 
		...
		new \Kirki\Field\Color(
			[
				...
				'label'       => __( 'Arrow Text Color', 'goldy-silver' ),
				'section'     => 'featured_slider_section',
				'priority' 	  => 30,
				'default'     => '#ffffff',
				'choices'     => [
