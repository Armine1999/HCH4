...
$our_team  = get_theme_mod( 'goldy_silver_our_team_content',$goldy_silver_default['options']['goldy_silver_our_team_content']);
if(empty($our_team)){
	$our_team  = $goldy_silver_default['options']['goldy_silver_our_team_content'];
}
// $our_teams = json_decode( $our_team );
			...
			<div class="our_team_info scroll-element js-scroll fade-in-bottom">
				<div class="our_team_main_title">
					<div class="our_team_tit heading_main_title">
						<h2><?php echo esc_html(get_theme_mod( 'goldy_silver_our_team_main_title',$goldy_silver_default['options']['goldy_silver_our_team_main_title'])); ?></h2>
					</div>

					<div class="our_team_main_disc">
						<p><?php echo esc_html(get_theme_mod( 'goldy_silver_our_team_desc',$goldy_silver_default['options']['goldy_silver_our_team_desc']));?></p>
					</div>
				</div>
