...
$our_testimonial  = get_theme_mod( 'our_testimonial_content',$goldy_silver_default['options']['our_testimonial_content']);

if(empty($our_testimonial)){
	$our_testimonial  = $goldy_silver_default['options']['goldy_silver_our_testimonial_section_content'];
}
			...
			<div class="our_testimonial_info scroll-element js-scroll fade-in-bottom">
				<div class="our_testimonial_main_title">
					<div class="testimonial_title heading_main_title">
						<h2><?php echo esc_html(get_theme_mod( 'our_testimonial_main_title',$goldy_silver_default['options']['our_testimonial_main_title'])); ?></h2>
						<span class="separator"></span>
					</div>
					<div class="our_testimonial_main_disc">
						<p><?php echo esc_html(get_theme_mod( 'our_testimonial_desc',$goldy_silver_default['options']['our_testimonial_desc']));?></p>
					</div>
				</div>
